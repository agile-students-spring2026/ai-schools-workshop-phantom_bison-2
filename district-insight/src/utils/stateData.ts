...
export const STATES: StateInfo[] = [
  { name: 'Alabama', abbr: 'AL', fips: 1 },
  { name: 'Alaska', abbr: 'AK', fips: 2 },
  { name: 'Arizona', abbr: 'AZ', fips: 4 },
  { name: 'Arkansas', abbr: 'AR', fips: 5 },
  { name: 'California', abbr: 'CA', fips: 6 },
  { name: 'Colorado', abbr: 'CO', fips: 8 },
  { name: 'Connecticut', abbr: 'CT', fips: 9 },
...
export function getStateByFips(fips: number): StateInfo | undefined {
  return STATES.find(s => s.fips === fips)
}
